...
<qgis version="3.40.15-Bratislava">
  <identifier>C:/Users/isavi/Documents/Aulas/sigII/BDG_projetofinal_v1.gpkg|layername=Mapa_de_Solos_do_Paran_EMBRAPA</identifier>
  <parentidentifier>Mapa de solos do Paraná</parentidentifier>
  <language>pt</language>
  <type>dataset</type>
  <title>Mapa_de_Solos_do_Paran_EMBRAPA</title>
  <abstract>Este plano de informação representa a distribuição espacial dos solos do estado do Paraná de acordo com Sistema Brasileiro de Classificação de Solos (SiBCS, 2006). Escala: 1:250.000.
</abstract>
  ...
  <contact>
    <name></name>
    <organization>EMBRAPA</organization>
    <position></position>
    <voice></voice>
    <fax></fax>
    <email></email>
