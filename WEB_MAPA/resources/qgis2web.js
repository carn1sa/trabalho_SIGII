...
map.getView().fit([-5431947.526011, -2983384.659221, -5428140.002402, -2980679.472714], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Aspectos do Sambaqui do Rio Branco</h2>';
        return titleElement;
    })(),
